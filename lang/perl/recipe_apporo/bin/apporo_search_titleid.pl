...
sub search {
    ...
    my $s_config_path = $FindBin::Bin."/../conf/titleid_surface.conf";
    my $y_config_path = $FindBin::Bin."/../conf/titleid_yomi.conf";
    my $r_config_path = $FindBin::Bin."/../conf/titleid_roman.conf";
